...
class CreateKnowHowViewController: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    ...
    @IBOutlet weak var requiredMaterialTextView: UITextView!
    ...
    private func setUpView(){
        ...
        requiredMaterialTextView.text = ""
        requiredMaterialTextView.layer.borderWidth = 0.1
        requiredMaterialTextView.layer.borderColor = UIColor.black.cgColor
        requiredMaterialTextView.layer.cornerRadius = 5
    ...
    @IBAction func postButtonTapped(_ sender: UIBarButtonItem) {
        ...
        let postdic = ["title":titleTextField.text!,"name":name!,"detail":detailTextView.text!,"rateId":rateId,"categoryId":categoryId,"time":String(time),"requiredTimeId":requiredTimeId,"requiredMaterialId":self.requiredMaterialTextView.text!,"share":"\(share)","userId":userId] as [String : Any]
